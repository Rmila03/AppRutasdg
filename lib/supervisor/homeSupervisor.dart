...
class MyHomeSupervisorPage extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: CustomMenuItem(title: 'Inicio', onPressed: () {}),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: CustomMenuItem(title: 'Reportes', onPressed: () {}),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: CustomMenuItem(title: 'Cartera', onPressed: () {}),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: CustomMenuItem(title: 'Dashboards', onPressed: () {}),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: CustomMenuItem(title: 'Configuración', onPressed: () {}),
          ),
        ],
      ),
      body: Padding(
